...
def sign(credentials, http_method, path, headers, params,
    ...
    print('sign_str - %s' % string_to_sign)
...
if __name__ == "__main__":
    ak = 'a26e6d209c0d4bad9351922a43be635d'
    sk = '902bc1a1ad6c4aac9153e84b1ac5fc23'

    credentials = BceCredentials(ak, sk)
    http_method = "POST"
    path = "/v1/feed/cloud/AccountFeedService/getAccountFeed"
    headers = {"host": "sem.baidubce.com",
               #"content-length": 8,
    ...
    data = {}
    data['accountFeedFields'] = ['userId', 'balance', 'budget', 'userStat', 'balancePackage', 'uaStatus', 'validFlows']
    data_json = json.dumps(data)
    params = {}
    timestamp = 1487547117
